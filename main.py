...
def attack(char_name: str, char_class: str) -> str:
    """Проверяет и выводит нанесенный урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """Проверяет и выводит, сколько урона было заблокировано."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Проверяет и выводит, какое умение было применено."""
    if char_class == 'warrior':
...
if __name__ == '__main__':
    """Выводит приветствие и общую информацию о игроке."""
    run_screensaver()
